...
const BlogPostCard = ({ content, author, }) => {
  let { publishedAt, tags, title, des, profile_img, fullname, username, banner, activity, blog_id: id } = content;
  let total_likes = activity?.total_likes || 0; // nếu undefined thì gán = 0
